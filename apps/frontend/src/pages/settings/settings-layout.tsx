...
export default function SettingsLayout() {
  ...
  const sections = [
      ...
      items: [
        {
          ...
          href: "general",
          subtitle: t("settings.nav.general.subtitle"),
          icon: <Icons.Settings2 className="size-5" />,
        },
        {
          title: t("settings.nav.appearance.title"),
          href: "appearance",
          subtitle: t("settings.nav.appearance.subtitle"),
          icon: <Icons.Monitor className="size-5" />,
        },
      ],
    },
    {
      title: t("settings.sections.portfolio"),
      items: [
        {
          title: t("settings.nav.accounts.title"),
          href: "accounts",
          subtitle: t("settings.nav.accounts.subtitle"),
          icon: <Icons.CreditCard className="size-5" />,
        },
        {
          title: t("settings.nav.contributionLimits.title"),
          href: "contribution-limits",
          subtitle: t("settings.nav.contributionLimits.subtitle"),
    ...
    },
    {
      ...
      items: [
        {
          title: t("settings.nav.securities.title"),
          href: "securities",
          subtitle: t("settings.nav.securities.subtitle"),
          icon: <Icons.BadgeDollarSign className="size-5" />,
        },
        {
          title: t("settings.nav.taxonomies.title"),
          href: "taxonomies",
          subtitle: t("settings.nav.taxonomies.subtitle"),
          icon: <Icons.Blocks className="size-5" />,
        },
        {
          title: t("settings.nav.exports.title"),
          href: "exports",
          subtitle: t("settings.nav.exports.subtitle"),
    ...
    },
    {
      ...
      items: [
        {
          title: t("settings.nav.connect.title"),
          href: "connect",
          subtitle: t("settings.nav.connect.subtitle"),
          icon: <Icons.CloudSync2 className="size-6 text-blue-400" />,
        },
        {
          title: t("settings.nav.marketData.title"),
          href: "market-data",
          subtitle: t("settings.nav.marketData.subtitle"),
          icon: <Icons.BarChart className="size-5" />,
        },
        {
          title: t("settings.nav.aiProviders.title"),
          href: "ai-providers",
          subtitle: t("settings.nav.aiProviders.subtitle"),
    ...
    },
    {
      ...
      items: [
        {
          title: t("settings.nav.addons.title"),
          href: "addons",
          subtitle: t("settings.nav.addons.subtitle"),
    ...
    },
    {
      ...
      items: [
        {
          title: t("settings.nav.about.title"),
          href: "about",
          subtitle: t("settings.nav.about.subtitle"),
