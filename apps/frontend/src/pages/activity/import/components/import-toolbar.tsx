    ...
    >
      ...
      <div className="text-muted-foreground flex shrink-0 items-center gap-2 text-sm">
        ...
        <span className="font-medium">
          {t("activity.importGrid.rowsSelected", { count: selectedCount })}
        </span>
      </div>
      ...
      <div className="flex shrink-0 items-center gap-1.5">
        ...
        <Button
          ...
          size="sm"
          onClick={onSkip}
          title={t("activity.importGrid.skipSelectedRows")}
          className="h-8"
        >
          <Icons.MinusCircle className="mr-1.5 h-3.5 w-3.5" />
          {t("activity.importGrid.skip")}
        </Button>
        ...
        <Button
          ...
          size="sm"
          onClick={onUnskip}
          title={t("activity.importGrid.unskipSelectedRows")}
          className="h-8"
        >
          <Icons.PlusCircle className="mr-1.5 h-3.5 w-3.5" />
          {t("activity.importGrid.unskip")}
        </Button>
        ...
        {onForceImport && (
          <Button
            ...
            title={t("activity.importGrid.importAnywayTitle")}
          ...
          >
            ...
            {t("activity.importGrid.importAnyway")}
          </Button>
        )}
        ...
        <Button
          ...
          title={t("activity.importGrid.clearSelection")}
          className="h-8 px-2"
        >
    ...
    <DropdownMenu open={open} onOpenChange={onOpenChange}>
      ...
      <DropdownMenuContent align="start" className="w-52">
        ...
        <DropdownMenuItem onSelect={onSkip}>
          ...
          {t("activity.importGrid.skipSelected")}
        </DropdownMenuItem>
        <DropdownMenuItem onSelect={onUnskip}>
          <Icons.PlusCircle className="mr-2 h-4 w-4" />
          {t("activity.importGrid.unskipSelected")}
        </DropdownMenuItem>
        {onForceImport && (
