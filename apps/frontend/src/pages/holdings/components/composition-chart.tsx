...
const DisplayModeToggle: React.FC<{
  ...
  return (
    <Tooltip>
      ...
      <TooltipContent>
        <p>{displayMode === "symbol" ? t("holdings.composition.showFullNames") : t("holdings.composition.showSymbols")}</p>
      </TooltipContent>
    </Tooltip>
  );
};
      ...
      <Card>
        <CardContent className="space-y-3 p-4">
          ...
          <div className="space-y-2">
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground pr-6 text-sm">{t("holdings.composition.marketValue")}</span>
            ...
            {/* Gain/Loss */}
            <div className="flex items-center justify-between">
              <span className="text-muted-foreground text-sm">{t("holdings.composition.return")}</span>
              <span
                className={cn(
    ...
    return (
      <Card>
        <CardHeader className="flex flex-row items-center justify-between space-y-0">
          <div className="flex items-center space-x-2">
            <Icons.LayoutDashboard className="text-muted-foreground h-4 w-4" />
            <CardTitle className="text-md font-medium">{t("holdings.composition.title")}</CardTitle>
          </div>
        </CardHeader>
        <CardContent className="flex h-[500px] items-center justify-center">
          <EmptyPlaceholder
            icon={<Icons.BarChart className="h-10 w-10" />}
            title={t("holdings.composition.noHoldingsData")}
            description={t("holdings.composition.noHoldingsDataDescription")}
          />
        </CardContent>
      </Card>
    );
